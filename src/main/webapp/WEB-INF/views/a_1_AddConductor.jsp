		...
		<div class="pd-ltr-20 xs-pd-20-10" >
			<div class="min-height-200px" >
				...
				<div class="pd-20 card-box mb-30" style="background: #fff">
					<div class="clearfix">
						<h4 class="text-blue h4">Add Conductor</h4>
						
					</div>
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard" action="addConductor" method="post">
							<h5>ID</h5>
							<section>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control"  name="cid" placeholder="Enter Conductor ID">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control"  name="cname" placeholder="Enter Conductor Name">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="email" class="form-control"  name="cemail" placeholder="Enter Conductor Email">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control"  name="cmobile" placeholder="Enter Conductor Mobile No">
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="caddress" placeholder="Enter Conductor Address">
										</div>
									</div>
								</div>
							</section>
							...
							<section>
							  <div class="row">
							    <div class="col-md-12">
							      <div class="form-group">
							        <select id="gender" name="cgender" class="form-control" required>
...
<!-- Step 4 -->
							...
							<section>
							  <div class="row">
							    <div class="col-md-12">
							      <div class="form-group">
							        <select id="gender" name="cdutyType" class="form-control" required>
							           <option value="">Select</option>
							...
							<section>
							  <div class="row">
							    <div class="col-md-12">
							      <div class="form-group">
							        <input type="text" class="form-control" id="status" name="cstatus" value="Available" readonly>
							      </div>
							    </div>
							  </div>
