...
<html lang="en">
    ...
    max-width: 500px;
    background: linear-gradient(to right, #e6ffed, #c1f7d5); /* lighter green gradient */
    ...
    border-radius: 10px;
    padding: 15px 25px;
    box-shadow: 0 4px 12px rgba(25, 135, 84, 0.2); /* deeper shadow */
    display: flex;
    align-items: center;
    gap: 15px;
...
<div style="background: linear-gradient(to right, #fefefe, #f0f0f0); padding: 2rem 0;">
    ...
    <img src="./resources/vendors/images/already1.png" style="width: 220px; height: 220px;">
</div>

<!-- Alert banner -->
<div class="alert-banner">
    <i class="fa-solid fa-circle-check"></i>
    Schedule is Already Generated Successfully!!
</div>
