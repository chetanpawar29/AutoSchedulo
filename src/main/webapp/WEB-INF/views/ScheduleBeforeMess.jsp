...
<html lang="en">
    ...
    .alert-banner {
        ...
        max-width: 700px;
        background: linear-gradient(to right, #ffe0e0, #ffbcbc);
        color: #9c0000;
        font-weight: 600;
        font-size: 18px;
...
<div style="background: linear-gradient(to right, #fefefe, #f0f0f0); padding: 2rem 0;">
    ...
    <div style="text-align: center; margin-top: 10%; margin-left: 23%;">
        <img src="./resources/vendors/images/warning.png" style="width: 220px; height: 220px;">
    </div>

    <!-- Alert banner -->
    <div class="alert-banner">
        <i class="fas fa-exclamation-triangle"></i>
        Schedule generation is allowed only between <strong>5:00 PM</strong> and <strong>11:59 PM</strong>
    </div>
