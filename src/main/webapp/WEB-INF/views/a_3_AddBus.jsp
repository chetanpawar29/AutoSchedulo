			...
			<div class="min-height-200px" >
				...
				<div class="pd-20 card-box mb-30" style="background: #fff">
					...
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard" action="addBus" method="post">
							<h5>ID</h5>
							<section>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control"  name="bid" placeholder="Enter Bus ID">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="number" class="form-control"  name="bseats" placeholder="Enter No. Seats">
										</div>
									</div>
