			...
			<table class="table" style="text-align: center;font-size: 5rem; border: 2px solid; border-bottom: 2px solid;">
				<thead>
					<tr>
						...
						<th scope="col">Conductor Address</th>
						<th scope="col">Conductor Mobile</th>
						<th scope="col">Conductor Email</th>
						<th scope="col">Conductor Gender</th>
						<th scope="col">Conductor Status</th>
				...
				%>
					<tr>
						...
						<td><%= c.getCstatus() %></td>
						<td>
							<a href="update?cid=<%= c.getCid() %>&cname=<%= c.getCname() %>&caddress=<%= c.getCaddress() %>&cmob=<%= c.getCmob() %>&cemail=<%= c.getCemail() %>&cgender=<%= c.getCgender() %>&cstatus=<%= c.getCstatus() %>">
								<span class="badge badge-info">Update</span>
							</a>
						</td>
						<td>
							<a href="deleteC?cid=<%= c.getCid() %>">
