	        ...
	        <div class="login-box box-shadow border-radius-10"
	            ...
	            box-shadow: rgba(0, 0, 0, 0.25) 0px 14px 28px,
						...
						<div class="login-title">
							<h2 class="text-center text-primary" style="color:#028391">Driver Login</h2>
						</div>
						<form action="loginDriver" method="post">
							
							
							<div class="input-group custom">
								<input type="number" name="did" class="form-control form-control-lg" placeholder="Enter Driver Id">
								<div class="input-group-append custom">
									<span class="input-group-text"><i class="dw dw-padlock1"></i></span>
								</div>
							</div>
							<div class="input-group custom">
								<input type="text" name="dname" class="form-control form-control-lg" placeholder="Enter Driver Name">
								<div class="input-group-append custom">
