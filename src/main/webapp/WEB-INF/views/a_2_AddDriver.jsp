		...
		<div class="pd-ltr-20 xs-pd-20-10" >
			<div class="min-height-200px" >
				...
				<div class="pd-20 card-box mb-30" style="background: #fff">
					<div class="clearfix">
						<h4 class="text-blue h4">Add Driver</h4>
						
					</div>
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard" action="addDriver" method="post">
							<h5>ID</h5>
							<section>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control"  name="did" placeholder="Enter Driver ID">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control"  name="dname" placeholder="Enter Driver Name">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="email" class="form-control"  name="demail" placeholder="Enter Driver Email">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control"  name="dmob" placeholder="Enter Driver Mobile No">
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="daddress" placeholder="Enter Driver Address">
										</div>
									</div>
								</div>
							</section>
							...
							<section>
							  <div class="row">
							    <div class="col-md-12">
							      <div class="form-group">
							        <select id="gender" name="dgender" class="form-control" required>
...
<!-- Step 4 -->
							...
							<section>
							  <div class="row">
							    <div class="col-md-12">
							      <div class="form-group">
							        <select id="gender" name="ddutyType" class="form-control" required>
							           <option value="">Select</option>
							...
							<section>
							  <div class="row">
							    <div class="col-md-12">
							      <div class="form-group">
							        <input type="text" class="form-control" id="status" name="dstatus" value="Available" readonly>
							      </div>
							    </div>
							  </div>
