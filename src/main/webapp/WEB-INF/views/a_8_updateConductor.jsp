		...
		<div class="pd-ltr-20 xs-pd-20-10" >
			<div class="min-height-200px" >
				...
				<div class="pd-20 card-box mb-30" style="background: #fff">
					<div class="clearfix">
						<h4 class="text-blue h4">Update Conductor</h4>
						
					</div>
					<div class="wizard-content">
						<form class="tab-wizard wizard-circle wizard" action="updatingConductor" method="post">
							<h5>ID</h5>
							<section>
								<div class="row">
									<div class="col-md-12">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="email" class="form-control"  name="cemail" value="<%=cemail%>">
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control"  name="cmob" value="<%=cmob%>">
										</div>
									</div>
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="caddress" value="<%=caddress%>">
										</div>
									</div>
								</div>
							</section>
...
<!-- Step 4 -->
							...
							<section>
							  <div class="row">
							    <div class="col-md-12">
							      <div class="form-group">
							        <input type="text" class="form-control" id="status" name="cstatus" value="<%=cstatus%>">
							      </div>
							    </div>
							  </div>
